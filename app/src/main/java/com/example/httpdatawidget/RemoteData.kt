...
//            Toast.makeText(context, "Widget has been updated! ", Toast.LENGTH_SHORT).show()
    ...
    companion object {
        ...
        internal fun updateAppWidget(
            ...
            val pendingConfigurationIntent = PendingIntent.getActivity(context, 0, configurationIntent, PendingIntent.FLAG_UPDATE_CURRENT)
            ...
            loadWidgetConfig(context, appWidgetId) { widgetConfig, datasourceInfo ->
                if (widgetConfig === null) {
                    views.setTextViewText(R.id.appwidget_label, "Error")
                    views.setTextViewText(R.id.appwidget_content, "No widget found")
                    ...
                    loadAndUpdateData(context, views, appWidgetId, datasourceInfo ?: info)
                }
            }
